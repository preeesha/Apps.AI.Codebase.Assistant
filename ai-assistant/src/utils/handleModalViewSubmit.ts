...
import { FIND_SIMILAR_COMMAND_MODAL, findSimilarModalSubmitHandler } from "../commands/FindSimilar.modal"
import { IMPROVE_COMMAND_MODAL, improveModalSubmitHandler } from "../commands/ImproveCommand.modal"
import { TESTCASES_COMMAND_MODAL, testcasesModalSubmitHandler } from "../commands/TestcasesCommand.modal"
...
export async function handleModalViewSubmit(
   ...
   const slashCommandContext = await getUIData<SlashCommandContext>(read.getPersistenceReader(), user.id)
